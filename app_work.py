...
def atualizaSiga():
    ...
    # acesso ao siga
    sleep(2)
    pyautogui.click(438,410,duration=2)
    pyautogui.write(lista[0])
    sleep(1)
    pyautogui.click(513,486,duration=1)
    pyautogui.write(lista[1])
    pyautogui.click(608,580, duration=1)
    sleep(2)

    # clicar em sites
    pyautogui.click(1088,254, duration=2)
    sleep(2)

    # clicar em meus sites
    pyautogui.click(66,241, duration=2)
    sleep(2)

    # clicar no site central de atendimento JF
    pyautogui.click(65,292, duration=2)
    sleep(2)

    # mover para paginas
    pyautogui.moveTo(90,347, duration=1)
    sleep(2)

    # clicar em todas as paginas
    pyautogui.click(216,347, duration=1)
    sleep(2)

    # clicar duas vezes na página de rolagem
    pyautogui.doubleClick(1909,991, duration=2)
    sleep(2)

    # clicar em Formularios
    pyautogui.click(255,715, duration=2)
    sleep(2)

    # clicar na area de codigo
    pyautogui.click(255,715, duration=1)
    sleep(2)
    ...
    pyautogui.tripleClick(1910,138, duration=2)
    sleep(1)

     # clicar em atualizar
    pyautogui.click(1831,604, duration=2)
    sleep(3)

    # mover até "olá Carlos"
    pyautogui.moveTo(1701,119, duration=1)
    sleep(1)
    
    # clicar botão sair
    pyautogui.click(1701,235, duration=2)
